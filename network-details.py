...
class Network_Details(object):
    def __init__(self):
        ...
        self.sepeed_parser = speedtest.Speedtest()
    ...
    def __repr__(self):
        down = str(f'{round(self.sepeed_parser.download()/1_000_000, 2)} Mbps')
        up = str(f'{round(self.sepeed_parser.upload()/1_000_000, 2)} Mbps')
